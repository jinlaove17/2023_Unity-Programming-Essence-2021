...
public class ItemSpawner : MonoBehaviour
{
    ...
    public float maxDistance = 5.0f; // 플레이어 위치로부터 아이템이 배치될 최대 반경

    public float timeBetSpawnMax = 7.0f; // 최대 시간 간격
    public float timeBetSpawnMin = 2.0f; // 최소 시간 간격
    ...
    private void Update()
    {
        // 현재 시점이 마지막 생성 시점에서 생성 주기 이상 지남 && 플레이어 캐릭터가 존재함
